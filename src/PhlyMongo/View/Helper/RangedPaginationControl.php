 ...
 * @note added extra logic inside __invoke method
 */
...
class RangedPaginationControl extends AbstractHelper
{
    /**
    ...
    public function __invoke(Paginator\Paginator $paginator = null, $scrollingStyle = null, $partial = null, $params = null)
    {
        ...
        if (!($paginator->getAdapter() instanceof RangedPaginatorAdapterInterface)) {
        	throw new Exception\RuntimeException('Paginator adapter instance must implement RangedPaginatorAdapterInterface');
        }
        ...
        $this->view->currentId = $paginator->getAdapter()->getCurrentId();
        $this->view->step = new RangedStepCalculator($paginator->getCurrentPageNumber());
